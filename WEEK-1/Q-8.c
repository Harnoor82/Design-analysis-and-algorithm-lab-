// Q8 Write a C program using structures to store student details and marks in 5 subjects. Calculate total, percentage, and grade, and display the student results, class topper, failed students, and class average. 
